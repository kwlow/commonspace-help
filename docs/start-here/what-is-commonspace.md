...
Commonspace replaces that dependency. It gives you the infrastructure to publish, sell, and build community on a space that belongs to you — with full ownership of your audience data and relationships.
...
**Content publishing**
Publish Update Posts to your Space, distribute them directly to members, and gate any post to members only. Full control over who sees what.
...
- **Professional Organizations** — industry networks with gated content and member channels
- **Conferences & Events** — attendee communities before, during, and after the event

> **[IMAGE: Example Spaces across different use cases]**
...
|---|---|---|
| Price | Free | $29/month |
| Monthly Active Members included | Up to 100 | Up to 3,000 |
| Additional members | $0.01/member | $0.01/member |
| Commission on sales | 15% | 10% |
| Custom domain | — | Yes |
